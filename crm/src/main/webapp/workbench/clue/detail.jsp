		...
		$.ajax({
			...
			success : function (data) {
				...
				$.each(data,function (i, n) {
					...
					html += '<font color="gray">线索</font> <font color="gray">-</font> <b>'+n.fullname+n.appellation + '-'+n.company+'</b> <small style="color: gray;"> '+(n.editFlag==0?n.createTime:n.editTime)+' 由'+(n.editFlag==0?n.createBy:n.editBy)+'</small>';
